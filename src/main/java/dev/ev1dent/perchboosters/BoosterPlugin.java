...
import dev.ev1dent.perchboosters.commands.tabcompletion.TabCompleterPerchBoosters;
...
public final class BoosterPlugin extends JavaPlugin {
    ...
    private void registerCommands(){
        this.getCommand("perchrewards").setExecutor(new CommandPerchBoosters());
        this.getCommand("perchrewards").setTabCompleter(new TabCompleterPerchBoosters());
    }
